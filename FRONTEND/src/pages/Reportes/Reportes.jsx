...
import { useMantenimiento } from '../../context'
...
export const Reportes = () => {
  ...
  const handleGenerarMasivo = async () => {
    ...
    try {
      ...
      exportarReporteMasivoPDF(ordenesCompletas, {
  ...
  return (
    <div className="reportes">
      ...
      <Card title="Informe técnico de mantenimiento">
        <p className="reportes__text">
          Genere el informe técnico desde una orden completada. Incluye resumen, evidencias, firma y exportación a PDF o Excel.
        </p>
        {loading ? (
          <Loader />
        ) : completadas.length === 0 ? (
          <p className="reportes__empty">No hay órdenes completadas para generar informes.</p>
        ) : (
